...
\NormalTok{mse =}\StringTok{ }\KeywordTok{mean}\NormalTok{((test}\OperatorTok{$}\NormalTok{solubility }\OperatorTok{-}\StringTok{ }\NormalTok{fit_lm_test)}\OperatorTok{^}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
